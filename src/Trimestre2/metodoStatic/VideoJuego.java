package Trimestre2.metodoStatic;
...
public class VideoJuego {
 ...
 //---------------------------------------------------------------------------------------------------------------------------
    ...
    public VideoJuego(String codigo, boolean disponible,Integer vecesAlquilado ) {
        this.codigo = codigo;
    ...
    public boolean equals(Object o) {
        ...
        return disponible == that.disponible && Objects.equals(codigo, that.codigo) && Objects.equals(titulo, that.titulo) && Objects.equals(plataforma, that.plataforma) && categoria == that.categoria && Objects.equals(vecesAlquilado, that.vecesAlquilado);
    }

    @Override
    public int hashCode() {
        return Objects.hash(codigo, titulo, plataforma, categoria, disponible, vecesAlquilado);
    }

     static String generarCodigoJuegos(){
        return totalJuegos + "-"
                + String.format("%04d", totalJuegos);
    }
