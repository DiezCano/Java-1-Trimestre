...
public class Ejercicio11Clase {
        /**
         * Crea un programa que reciba una cadena de caracteres y la devuelva invertida con efecto
         * espejo. Se concatena a la palabra original su inversa, compartiendo la última letra, que hará
         * de espejo. Por ejemplo, al introducir "teclado" devolverá "tecladodalcet". Haz dos versiones,
